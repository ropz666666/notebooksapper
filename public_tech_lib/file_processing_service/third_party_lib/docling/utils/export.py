...
from public_tech_lib.file_processing_service.third_party_lib.docling.datamodel.base_models import OcrCell
from public_tech_lib.file_processing_service.third_party_lib.docling.datamodel.document import ConversionResult, Page
