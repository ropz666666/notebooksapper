...
import { SysMenuRes, SysMenuTreeRes } from './menu';
...
export function updateSysRoleMenu(pk: number, data: SysRoleMenuReq) {
  return axios.put(`/v1/sys/roles/${pk}/menu`, data);
}
